<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewkeyskillupdateloginadmin.aspx.cs" Inherits="keyskillsupdate" %>
    ...
    <div class="keyup">
        <div id="root">
            ...
            <div id="skills">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#006666"  Text="VIEW KEY SKILLS.." style="z-index: 1; left: 419px; top: 241px; position: absolute; width: 448px"></asp:Label>
                <br />
                <br />
                <fieldset class="skil">

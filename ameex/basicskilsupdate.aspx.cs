...
public partial class basicskilsupdate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            String Empidquery = "select eid from regi where mail='" + val + "'";
            var empid = GetData(sqlConnection, Empidquery);
            ...
            if (empid != null ? empid.Rows.Count > 0 : false)
            {
                foreach (DataRow dr in empid.Rows)
                {
                    ...
                    str = dr["eid"] != null ? dr["eid"].ToString() : string.Empty;
                }

            }
           
            string query1 = "select skillid,skillname from skillstab where skilltype='basicskill'";
            string query2 = "select skillid,filename from emploskills where eid='" + str + "' ";
    ...
    /// <summary>
    /// To insert the basic skills into employee skills table
    /// </summary>
    ...
    /// <summary>
    /// To update the new basic skill into skills table
    /// And update the basic skills
    /// </summary>
    /// <param name="str"> str is id</param>

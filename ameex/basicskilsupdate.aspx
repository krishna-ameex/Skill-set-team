<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="basicskilsupdate.aspx.cs" Inherits="basicskilsupdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <fieldset class="basik">
        ...
        <asp:Label ID="Label1" runat="server" Text="UPDATE BASIC SKILLS" style="z-index: 1; left: 514px; top: 154px; position: absolute; width: 316px;" Font-Bold="True" Font-Size="X-Large" ForeColor="#006666"></asp:Label>
        <br />
        <br />
       ...
       <fieldset class="addit">  
        ...
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/selectim.jpg" style="z-index: 1; left: 246px; top: 331px; position: absolute; height: 38px; width: 68px" />

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <asp:Panel ID="Panel1" runat="server" Height="240px" > 
        <fieldset class="fled">
         ...
         <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" style="z-index: 1; left: 355px; top: 361px; position: absolute; width: 112px" Text="Back" CausesValidation="False" />
     </asp:Panel>
</asp:Content>

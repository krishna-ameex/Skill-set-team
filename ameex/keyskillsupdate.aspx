<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="keyskillsupdate.aspx.cs" Inherits="keyskillsupdate" %>
    ...
    <div class="keyup">
        <div id="root">
            ...
            <div id="skills">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#006666"  Text="UPDATE KEY SKILLS.." style="z-index: 1; left: 494px; top: 149px; position: absolute; width: 448px"></asp:Label>
                <br />
                <br />
                <fieldset class="skil">
                ...
                <asp:Label ID="Label2" runat="server" Text="Click Here to Select  Below  Skills" Font-Bold="True"></asp:Label>
                    ...
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/leftarow.jpg" style="z-index: 1; left: 631px; top: 334px; position: absolute; height: 26px; width: 49px" />
                <br />
                    <br />
